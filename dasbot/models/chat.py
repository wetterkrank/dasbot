...
class Chat(object):
    def __init__(self, chat_id, user={}, subscribed=True, last_seen=None, quiz=None,
                 quiz_scheduled_time=None, quiz_length=None, quiz_mode=None, hint_language=None, dictionary_mode=None):
        self.id = chat_id
        ...
        self.dictionary_mode = dictionary_mode or DictionaryMode.Default
...
class ChatSchema(Schema):
    ...
    dictionary_mode = fields.Enum(DictionaryMode, by_value=True, load_default=None)
